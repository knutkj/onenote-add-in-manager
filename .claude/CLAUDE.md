this is a wpf application. maintainability is super important. follow idiomatic
...
building the wpf app: `dotnet build`. running the wpf app:
`dotnet run --project OneNoteAddinManager.App`
